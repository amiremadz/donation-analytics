...
if __name__ == "__main__":
	percentile = find_precentile(input_path, pcnt_file)
	df = preprocess(input_path, data_file)
	df = postprocess(df)
	print(df)
	df.to_csv(os.path.join(output_path, output_file), sep='|', header=False, index=False)